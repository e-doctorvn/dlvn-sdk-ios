...
spec.source = { :git => "https://github.com/e-doctorvn/dlvn-sdk-ios.git", :tag => 'v1.0.2' }
spec.source_files = "Sources/EdoctorDlvnSdk/*.{swift}"
spec.readme = "https://github.com/e-doctorvn/dlvn-sdk-ios/#{spec.version.to_s}/README.md"
end
